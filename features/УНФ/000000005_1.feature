...
Функциональность: Платный ремонт думает с согласием покупателя

@КодНастройкиПроцесса=000000005
@ПолныйКодПроцесса=04.04
Сценарий: Платный ремонт думает с согласием покупателя
